...
We will work with this [data set](data/movie_series.csv) in the course. 
...
### Online
If it is not possible for you to install R and Positron on your personal computer, 
[Posit Cloud](https://posit.cloud//) offers a free, online alternative,
where you will be able to run R and RStudio in your browser. Currently, Positron does not offer a similar solution.
...
* Open Positron, and click on "Help" > "Install Updates". If a new version is
	available, quit Positron, and download the latest version for Positron.
...
* From the list of versions, choose **Positron x.yy.zzz - Windows.
...
* Open Positron, and click on "Help" > "Install Update". If a new version is
	available, quit Positron, and download the latest version for Positron.
* To check the version of R you are using, start Positron and the first thing
...
* It is also a good idea to install [XQuartz](https://www.xquartz.org/) (needed
  by some packages).
* Go to the [Positron download page](https://positron.posit.co/download.html).
* Select the relevant version of **Positron x.yy.zzz - Mac OS X 10.6+ (64-bit)**
...
* Select the version that matches your distribution, and
  install it with your preferred method (e.g., with Debian/Ubuntu `sudo dpkg -i
  Positron-x.yy.zzz-amd64.deb` at the terminal).
* Once it's installed, open Positron to make sure it works and you don't get any
  error messages.
