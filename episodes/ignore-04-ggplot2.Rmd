...
To enlarge your plot, click the "Open in editor tab" button in your Positron plots pane and select "Open in new window".
...
> beautiful graph of your own. Use the [**`ggplot2`** cheat sheet](https://www.rstudio.com/wp-content/uploads/2016/11/ggplot2-cheatsheet-2.1.pdf)
...
After creating your plot, you can save it to a file in your favourite format. The Save plot tab in the **Plot** pane in Positron will save your plots at low resolution, which will not be accepted by many journals and will not scale well for posters.
