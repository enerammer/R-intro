...
```{r rstudio-analogy, echo = FALSE, fig.show = "hold", out.width = "100%", fig.alt = "Positron extends what R can do, and makes it easier to write R code and interact with R."}
knitr::include_graphics("./fig/r-manual.jpeg")
```


```{r rstudio-analogy-2, echo = FALSE, fig.show = "hold", fig.alt = "automatic car gear shift representing the ease of Positron", out.width="100%"}
...
- Bottom Center - **Console**: what R would look and be like without RStudio
...
![Packages pane](fig/packages_pane.png){alt="Pane showing installed packages"}
...
![Install Packages Window](fig/R_00_Rstudio_03.png){alt="window for installing packages"}
